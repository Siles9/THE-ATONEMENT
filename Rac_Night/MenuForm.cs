...
namespace Rac_Night
{
    public partial class MenuForm : Form
    {
        ...
        private void InitializeMenuUI()
        {
            ...
            this.BackColor = Color.FromArgb(135, 206, 250); // Небесно-голубой фон

            // Заголовок игры
            Label titleLabel = new Label();
            titleLabel.Text = "THE ATONEMENT";
            titleLabel.Font = new Font("Impact", 48, FontStyle.Bold);
            titleLabel.ForeColor = Color.FromArgb(0, 0, 139); // Тёмно-синий цвет
            ...
            for (int i = 0; i < buttonTexts.Length; i++)
            {
                ...
                button.FlatAppearance.BorderColor = Color.FromArgb(0, 0, 139); // Тёмно-синяя обводка
            ...
            this.Paint += (sender, e) =>
            {
                ...
                // Генерируем случайные позиции облаков
                for (int i = 0; i < 3; i++)
                {
